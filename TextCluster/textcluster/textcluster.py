...
class TextCluster(object):
	...
	def parseArgs(self,args):
		...
		trainArgs.add_argument('--textRepresent',type=str,default='doc2vec',help='the style of text represention')
	...
	def mainTrain(self):
		...
		if self.arg.textRepresent.lower() == 'doc2vec':
	...
	def readCorpus(self):
		...
		with codecs.open(dirName,encoding='utf-8') as fr:
			...
			for corpus in self.corpus_list:
				self.sen_seg_list.append(" ".join(jieba.cut(corpus.strip())))
